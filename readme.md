...
Unlike the multiple line chart, the single line chart is able to show only one country at once. However, it help us in detecting more detail of each country like when the pandemic of the chosen country break out, when it grows exponentially, when it slow down, which the most dangerous period.
